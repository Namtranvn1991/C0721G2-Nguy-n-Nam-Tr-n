...
public class EmployeeServiceImpl implements EmployeeService {
    static final String EMPLOYEE_LIST_PATH = "src\\case_study\\furama\\data\\EmployeeList.csv";
    static ArrayList<Employee> employeesList = ReadEmployeeListAndWriteToCSV.getListEmployeeFromCSV(EMPLOYEE_LIST_PATH);
...
//
    ...
    public static void add(){
        ...
        ReadEmployeeListAndWriteToCSV.readEmployeeListAndWriteToCSV(employeesList,EMPLOYEE_LIST_PATH);
    }
