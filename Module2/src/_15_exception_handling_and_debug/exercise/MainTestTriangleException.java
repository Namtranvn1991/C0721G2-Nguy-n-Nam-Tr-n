...
public class MainTestTriangleException {
    ...
    static void illegalTriangle(int a, int b, int c) throws IllegalTriangleException {
        ...
        int c1 = a + b;
        if (a <= 0 || b <= 0 || c <= 0) {
            throw new IllegalTriangleException("Side of triangle cant be less than or equal to 0");
        } else if (a1 <= a || b1 <= b || c1 <= c) {
            throw new IllegalTriangleException("Any two sides of triangle needs to be greater than the other side");
        }
    }
}
