...
public class BlogService implements IBlogService {
    ...
    @Override
    public Page<Blog> findAllBlogByDescription(String description, Pageable pageable) {
        return iBlogRepository.findAllByDescriptionContaining(description,pageable);
    }

    @Override
    public List<Blog> findAllBlogByDescription(String description) {
        return iBlogRepository.findAllByDescriptionContaining(description);
    }
}
